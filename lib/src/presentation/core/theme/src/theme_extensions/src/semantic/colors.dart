...
class ColorExtension extends ThemeExtension<ColorExtension> {
  const ColorExtension.light()
    : brightness = Brightness.light,
      ...
      accent = const ColorAccent._(
        eco: _Leaf.s500,
        ecoStrong: _Leaf.s600,
        ecoTint: _Leaf.s50,
        ecoSoft: _Leaf.s100,
        sky: _Sky.s500,
        skyTint: _Sky.s50,
        picked: _Violet.s500,
        pickedTint: _Violet.s50,
      ),
  ...
  const ColorExtension.dark()
    : brightness = Brightness.dark,
      ...
      accent = const ColorAccent._(
        eco: _Leaf.s500,
        ecoStrong: _Leaf.s500,
        ecoTint: _Leaf.s900,
        ecoSoft: _Leaf.s900,
        sky: _Sky.s500,
        skyTint: _Sky.s900,
        picked: _Violet.s500,
        pickedTint: _Violet.s900,
      ),
      text = const ColorText._(
        onPrimary: _Neutral.s900,
        defaultValue: _Neutral.s200,
...
/// Secondary hues with a meaning: the eco green for impact stats, sky
/// teal for routes and transit, violet for the picked-up state.
final class ColorAccent {
  const ColorAccent._({
    required this.eco,
    required this.ecoStrong,
    required this.ecoTint,
    required this.ecoSoft,
    required this.sky,
    required this.skyTint,
    required this.picked,
    required this.pickedTint,
  });

  final Color eco;
  final Color ecoStrong;
  final Color ecoTint;
  final Color ecoSoft;
  final Color sky;
  final Color skyTint;
  final Color picked;
  final Color pickedTint;

  static ColorAccent _lerp(ColorAccent a, ColorAccent b, double t) {
    return ColorAccent._(
      eco: Color.lerp(a.eco, b.eco, t)!,
      ecoStrong: Color.lerp(a.ecoStrong, b.ecoStrong, t)!,
      ecoTint: Color.lerp(a.ecoTint, b.ecoTint, t)!,
      ecoSoft: Color.lerp(a.ecoSoft, b.ecoSoft, t)!,
      sky: Color.lerp(a.sky, b.sky, t)!,
      skyTint: Color.lerp(a.skyTint, b.skyTint, t)!,
      picked: Color.lerp(a.picked, b.picked, t)!,
      pickedTint: Color.lerp(a.pickedTint, b.pickedTint, t)!,
    );
  }
}
...
final class ColorBackground {
  ...
  /// The launch screen: true black in both modes, so the native launch
  /// image and the Flutter splash are one continuous surface.
  final Color splash;
  ...
  static ColorBackground _lerp(ColorBackground a, ColorBackground b, double t) {
    return ColorBackground._(
      ...
      splash: Color.lerp(a.splash, b.splash, t)!,
    );
  }
}
